...
##### <span style="color: #dd4930"> Рис. 1. Распределение вузов по доходам от платных услуг населению и фирмам   <span> {#ris1}
...
##### <span style="color: #dd4930"> Таблица 4. Внебюджетные доходы от платных услуг населению и фирмам  <span> {#tab4}
...
##### <span style="color: #dd4930"> Рис. 2. Соотношение доли доходов от платных услуг с абсолютным их выражением в рублях   <span> {#ris2}
...
##### <span style="color: #dd4930"> Таблица 5. Доходы от платных услуг населению и фирмам (в % от общих доходов) <span> {#tab5}
...
##### <span style="color: #dd4930"> Рис. 4. Соотношение доли доходов от платных услуг с абсолютным их выражением в рублях по группам регионов   <span> {#ris4}
...
##### <span style="color: #dd4930"> Таблица 6. Доходы от платных услуг населению и фирмам (в % от общих доходов): регионы <span> {#tab6}
...
##### <span style="color: #dd4930"> Таблица 8. Расходы на оплату труда, финансируемые за счет студентов и фирм   <span> {#tab8}
...
##### <span style="color: #dd4930"> Приложение 1.  Распределение доходов государственных вузов по источникам их получения и видам деятельности, 2019 год   <span> {#ap1}
...
##### <span style="color: #dd4930"> Приложение 2. Упрощенная версия отчета о финансовых результатах деятельности   <span> {#ap2}

![](imag/im3.png)

##### <span style="color: #dd4930"> Приложение 3. Топ-10 вузов по доходам от платных услуг населению и фирмам: в млн. рублей и в % от общих доходов вуза   <span> {.tabset}
...
##### <span style="color: #dd4930"> Приложение 4. Откуда взялась формулировка “как минимум”  <span> {#ap4}

При налализе расходов на оплату труда, финансируемых деньгами студентов и фирм мы были вынуждены перейти к формулировке “как минимум” из-за ограничений финансовых отчетов с которыми мы работали. Это значит, что Воронежский институт экономики и социального управления из [Таблицы 8](#tab8) возможно все 25 млн.руб. профинансировал деньгами студентов и фирм, но точно говорить мы можем только о 23 млн.руб. Чтобы понять принцип, рассмотрим упрощенный пример. 

Мы предполагаем, что вузы стремятся к сбалансированному бюджету – чтобы их доходы  равны расходам. Пусть у нас есть вуз со следующими данными в отчете:
...
##### <span style="color: #dd4930"> Приложение 4. Выпавшие вузы  <span> {#ap4}

t_base_30 <- merged_final %>% 
...
t_base_30 %>% select(short_name, all_inc, mark_inc, wage, all_w, dang) %>%  datatable ()
```
