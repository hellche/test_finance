...
Министерство экономического развития [прогнозирует](https://ria.ru/20200521/1571810701.html) снижение реальных доходов населения на 3,8%, что соответствует уровню среднего богатства 2011 года. Согласно недавнему [опросу]( https://www.rbc.ru/economics/07/07/2020/5eff14959a794725e351de43), каждый пятый в России заявил о значительном падении дохода из-за пандемии. В этой связи актуально будет рассмотреть финансовые риски, с которыми могут столкнуться российские вузы в ближайшее время из-за падения доходов населения и организаций. 

Основные статьи доходов университетов – это образование и исследования. Вузы предоставляют населению образовательные услуги по основным и дополнительным программам. Деньги поступают от государства через бюджетные места – каждое место имеет свою стоимость в зависимости от программы, типа университета и его расположения. Чем больше в университете бюджетных мест, тем больше он получит средств от государства. Платные студенческие места приносят средства от домохозяйств напрямую. Население финансирует около 30% образовательной деятельности, остальное вузы получают преимущественно от государства [(см. Прил. 1)](#ap1)

Помимо основных программ вузы предлагают дополнительные программы, спрос на которые в том числе предъявляют и фирмы. Научные исследования финансируются как государством, через гранты и госзаказ, так и фирмами. Исследования в целом являются менее значимой статьей доходов для вузов. По данным Министерства образования в среднем доход вузов от научных исследований составляет около 8% в общих доходах [(Прил. 1)](#ap1).  
Отсюда мы видим, что именно падение спроса на образование может существенно сократить статью доходов университетов. Можно ли ожидать значительного падения спроса на университетское образование?
...
Государственные (и муниципальные) организации высшего образования в 2019 году получили ~908 млрд. рублей из пяти источников [(Прил.1)](#ap1). Поступления от организаций и населения составили 36% доходов вузов. Снижение их платежеспособности может создать существенные риски  для вузов. На данных финансовой отчетности мы попытаемся ответить на следующие вопросы:
...
Немного подробнее о самих отчетах: они имеют матричную структуру (образец в упрощенной форме представлен в [Приложении 2](#ap2)). В отчете мы можем видеть не только общую сумму доходов по различным статьям, но и источник финансирования этих доходов. То есть, мы можем видеть, что вуз оказал услуг на 100 рублей, при этом, 60 рублей получил из бюджета, а 40 рублей – внебюджетные источники (фирмы и население). То же самое и с расходами – мы видим, что вуз заплатил сотрудникам 100 рублей, и мы точно знаем, какая часть из этих 100 рублей это бюджетные деньги, а какая внебюджетные. 
...
Следует отметить, что есть целая группа вузов, у которых доля таких доходов заметно выше среднего (все, кто сильно правее красной пунктирной линии на [Рис. 1](#ris1)). У 44% вузов (170 из 390) доля собственных доходов выше среднего значения. Рассмотрим далее подробнее группу вузов, для которых доля внебюджетных доходов составляет основной источник дохода.
...
table22 <- t4a1 %>% 
  #group_by(family_profile) %>% 
  summarise(family_profile = "Всего по Q3",
...
colnames(table_1_2_2)[1] <- "Семейства"
colnames(table_1_2_2)[2] <- "среднее Q3 (в %)"
colnames(table_1_2_2)[3] <- "медиана Q3 (в %)"
colnames(table_1_2_2)[4] <- "кол-во вузов в Q3"
colnames(table_1_2_2)[5] <- "% вузов в Q3"

knitr::kable(table_1_2_2 , booktabs = T, digits = 1) %>%
 kable_styling() %>% 
...
Проанализируем различия по двум группам: (1) столичные вузы – Москва и Санкт-Петербург и (2) региональные вузы – остальные регионы России. Повторим тот же график как на [Рис. 1](#ris1), но с разбивкой на эти две группы.
...
Все расходы вузов мы разделим на три группы: (1) Оплата труда (зарплата и прочие начисления); (2) Оплата работ и услуг: (связь, транспорт, коммунальные платежи и др.); (3) Прочее (пособия по социальной помощи населению и др.).
...
##### <span style="color: #dd4930"> Приложение 3. Откуда взялась формулировка “как минимум”  <span> {#tab3}
